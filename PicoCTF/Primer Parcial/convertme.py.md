...
## Solución
```
catnap-picoctf@webshell:~$ wget https://artifacts.picoctf.net/c/22/convertme.py
--2024-02-28 04:09:55--  https://artifacts.picoctf.net/c/22/convertme.py
...
2024-02-28 04:09:55 (53.0 MB/s) - 'convertme.py' saved [1189/1189]

catnap-picoctf@webshell:~$ cat convertme.py 
...
catnap-picoctf@webshell:~$ python3 convertme.py 
